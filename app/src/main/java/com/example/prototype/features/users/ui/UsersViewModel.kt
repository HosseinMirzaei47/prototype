...
import com.example.prototype.features.users.data.Data
...
class UsersViewModel @ViewModelInject constructor(
    ...
    private var _allUsersResult = MutableLiveData<Resource<List<Data>>>()
    val allUsersResult: LiveData<Resource<List<Data>>> get() = _allUsersResult
